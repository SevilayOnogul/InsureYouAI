...
namespace InsureYouAI.Controllers
{
    public class ElevenLabsAIController : Controller
    {
        ...
        public async Task<IActionResult> SpeakInsuranceAnswer(string text)
        {
            ...
            var apiKey = "sk_53524e2ea963dfbe1a9293f393f70cdb3948935705047e3e";
        ...
        public async Task<IActionResult> SpeakInsuranceAnswer3(string text)
        {
            ...
            // Gerçek senaryoda burada OpenAI / Gemini / Claude çağrılırsa cevap AI dan dönecek. Şİmdilik tanımlanan sesi yani text değerini seslendiriyor
            ...
            string apiKey = "sk_53524e2ea963dfbe1a9293f393f70cdb3948935705047e3e";
